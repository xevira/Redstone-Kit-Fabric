...
public class XPHelper {
    ...
    public static int removeLevels(PlayerEntity player, int levelsToRemove) {
        ...
        player.addExperienceLevels(-levelsToRemove);
    ...
    public static int getPlayerTotalExperience(PlayerEntity player) {
        ...
        exp += Math.round(player.experienceProgress * player.getNextLevelExperience());
        return exp;
    }

    public static int getExpNeededForNextLevel(PlayerEntity player) {
